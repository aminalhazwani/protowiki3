...
export const HOMEPAGE = '/mobile-popover-test'

/** Full-page mobile drill-down for the Your impact module. */
export const IMPACT_PAGE = '/mobile-popover-test/impact'

/** Full-page mobile drill-down for the Get help with editing module. */
export const HELP_PAGE = '/mobile-popover-test/help'

/** Full-page mobile drill-down for the Your mentor module. */
export const MENTOR_PAGE = '/mobile-popover-test/mentor'

/** Full-page mobile drill-down for the Suggested edits module. */
export const SUGGESTED_EDITS_PAGE = '/mobile-popover-test/suggested-edits'
