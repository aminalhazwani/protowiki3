...
import { CONFIGURE_SUGGESTIONS_INTERESTS_PAGE } from '../wikita-lite/routes'

definePage({
  meta: {
    title: 'Wikita-lite — Configure suggestions',
...
function openInterests() {
  void pushRoute(CONFIGURE_SUGGESTIONS_INTERESTS_PAGE)
}
