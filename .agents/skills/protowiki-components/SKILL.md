...
| `MobileWrapper`       | Phone-frame preview — full width below 480px; centred column + neutral Codex gutters when clamped; **`fluid`** drops the clamp for responsive prototypes                                                                                                                                                             | No              | No               |
...
| `MobileWrapper`       | `maxWidth?` (default `412px`), **`showFrameBorder?`**, **`fluid?`**, `lang?`, `dir?`                                                                                                                                                                                         | default                                                                                                                             |
