...
| `VectorStickyHeader`  | Condensed bar that slides over the content on scroll — automatic inside **`VectorChromeHeader`**, never mounted directly                                                                                                                                      | n/a             | n/a              |
...
// VectorStickyHeader mounts itself inside VectorChromeHeader — no direct import
...
| `VectorStickyHeader`  | `active?`, `theme?` — set by **`VectorChromeHeader`**; page subject comes from `stickyHeaderSubject.ts`                                                                                                                                 | —                                                                                                                                   |
